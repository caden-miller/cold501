...
users_data = [
  { email: 'sammycfigueroa@tamu.edu',
    full_name: 'Samantha Figueroa',
    uid: '1',
    avatar_url: 'https://lh3.googleusercontent.com/a/ACg8ocJo684Q6bzUhBBSquTf_DYY26jpktwPmU42EijRiW_3wzNyUA=s96-c',
    committee: 'Goat',
    points: '0',
    dues: '0',
    role: 'admin',
  ...
  { email: 'kflores205@tamu.edu',
    full_name: 'Katherine Flores',
    uid: '2',
    avatar_url: 'https://lh3.googleusercontent.com/a/ACg8ocJML4QmnK3k8A9l7FEwiCXY8_91omVaIO128TqblWlxyuxjRdI=s96-c',
    committee: 'Goat',
    points: '0',
    dues: '0',
    role: 'admin',
