...
users_data = [
  ...
  { email: 'kflores205@tamu.edu',
    ...
    created_at: '2024-09-16 18:55:30',
    updated_at: '2024-09-16 18:55:30' },
  { email: 'fisherb16@tamu.edu',
    full_name: 'Braden Fisher',
    uid: '3',
    avatar_url: 'https://lh3.googleusercontent.com/a/ACg8ocJ3YyBmeqdGpJ1C12xROb3NppcRmD20Ku1RGv0o6WLVbRuidQ=s96-c',
    committee: 'Goat',
    points: '0',
    dues: '0',
    role: 'admin',
